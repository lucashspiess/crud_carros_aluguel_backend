...
import br.ueg.prog.webi.faculdade.crud.mapper.TipoMapperImpl;
...
public class TipoController extends CrudController<Tipo, TipoDTO, Long, TipoMapperImpl, TipoServiceImpl> {
